...
using static FracturedTruth.ClientActions.FeatureItems.MainMenuStyle.MainMenuStyleManager;
using static FracturedTruth.Patches.System.TitleLogoPatch;
...
public static class MainMenuStylePanel
{
    ...
    private static void CreateApplyButton(ToggleButtonBehaviour template)
    {
        ...
        button.OnClick.AddListener(new Action(() =>
        {
            ...
            if (id == 3)
            {
                ...
                if (rd < 5)
                    sr.sprite = LoadSprite("FracturedTruth-BG-MiraStudioNewYear.png", 179f);
            }
    ...
    private static void CreatePreviewImage()
    {
        _previewImage = ObjectHelper.CreateSpriteRenderer(
            "FracturedTruth-BG-Preview",
            "FracturedTruth-BG-MiraHQ.png",
            450f,
    ...
    private static void Refresh(MainMenuStyleManager.BackGroundStyle style)
    {
