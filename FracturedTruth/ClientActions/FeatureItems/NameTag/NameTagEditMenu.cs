...
using TMPro;
using UnityEngine;
using static FracturedTruth.ClientActions.FeatureItems.NameTag.NameTagManager;
using Component = FracturedTruth.ClientActions.FeatureItems.NameTag.NameTagManager.Component;
...
public static class NameTagEditMenu
{
    ...
    private static void LoadComponent(NameTagManager.Component com, bool name = false)
    {
    ...
    {
        var com = new NameTagManager.Component();
        ...
        if (colors.Count > 1) com.Gradient = new NameTagManager.ColorGradient(colors.ToArray());
    ...
    private static bool SaveToFile(string friendCode, NameTagManager.NameTag tag)
    {
        ...
        var components = new Dictionary<string, NameTagManager.Component>
        {
            ["Title"] = tag.Title,
            ["Prefix"] = tag.Prefix,
            ["Suffix"] = tag.Suffix,
    ...
    private static NameTagManager.Component GetComponent(NameTagManager.NameTag tag, ComponentType type)
    {
        return type switch
        {
