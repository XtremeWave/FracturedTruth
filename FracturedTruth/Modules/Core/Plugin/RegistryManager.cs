...
{
    private static RegistryKey Keys = SoftwareKeys.OpenSubKey("AU-FracturedTruth", true);
    ...
    public static void Init()
    {
        if (Keys == null)
        {
            Info("Create FracturedTruth Registry Key", "Registry Manager");
            Keys = SoftwareKeys.CreateSubKey("AU-FracturedTruth", true);
        }
