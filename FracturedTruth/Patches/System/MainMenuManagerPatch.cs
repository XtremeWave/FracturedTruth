...
using FracturedTruth.Modules.Features;
...
public class MainMenuManagerPatch
{
    ...
    public static void Start_Postfix(MainMenuManager __instance)
    {
        ...
        InviteButton.name = "FracturedTruth Extra Link Button";
        ...
        //WebsiteButton.name = "FracturedTruth Website Button";
