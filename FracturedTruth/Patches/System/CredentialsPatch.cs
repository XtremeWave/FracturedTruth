using System.Text;
using FracturedTruth.ClientActions;
using FracturedTruth.ClientActions.FeatureItems.MainMenuStyle;
using FracturedTruth.Helpers;
using FracturedTruth.Modules.Core.Plugin;
using FracturedTruth.Modules.Resources;
using FracturedTruth.Patches.Game_Vanilla;
using FracturedTruth.Templates;
using Il2CppSystem;
using TMPro;
using UnityEngine;
...
using ColorHelper = FracturedTruth.Helpers.ColorHelper;
...
public class VersionShowerStartPatch
{
    ...
    public static void Postfix(VersionShower __instance)
    {
        ...
        if ((OVersionShower = GameObject.Find("VersionShower")) && !CreditTextCredential)
        {
            ...
            CreditTextCredential.name = "FracturedTruth CreditText";
            ...
            CreditTextCredential.enabled = GameObject.Find("FracturedTruth Background");
        ...
        ModLogo.AddComponent<SpriteRenderer>().sprite = LoadSprite("FracturedTruth-Logo.png", 250f);
    ...
    public static void CreateVisitText(VersionShower __instance)
    {
        ...
        VisitText.name = "FracturedTruth VisitText";
        ...
        VisitText.enabled = GameObject.Find("FracturedTruth Background");
...
internal class TitleLogoPatch
{
    public static void Postfix(MainMenuManager __instance)
    {
        ...
        FinalSuspect_Background = new GameObject("FracturedTruth Background")
        {
            transform =
            {
        ...
        logoRenderer.sprite = LoadSprite("FracturedTruth-Logo.png");
