...
public static class LoadPatch
{
    ...
    public class Start
    {
        ...
        private static void CreateLogoComponents()
        {
            ...
            _modLogo = ObjectHelper.CreateSpriteRenderer("Mod_Logo", "FracturedTruth-Logo.png", 150f,
                new Vector3(0, 0.3f, -5f));
            _modLogoBlurred = ObjectHelper.CreateSpriteRenderer("Mod_Logo_Blurred", "FracturedTruth-Logo-Blurred.png",
                150f,
                new Vector3(0, 0.3f, -5f));
            _glow = ObjectHelper.CreateSpriteRenderer("Glow", "FracturedTruth-Logo.png", 1f, new Vector3(0, 0.3f, -5f));
        }
        ...
        {
            _loadText.text = $"Welcome to <color={ColorHelper.FSColorHex}>FracturedTruth</color>.";
        }
