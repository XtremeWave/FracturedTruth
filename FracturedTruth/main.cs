...
using FracturedTruth.Internal;
using FracturedTruth.Modules.Core.Plugin;
using FracturedTruth.Modules.Random;
...
public class Main : BasePlugin
{
    ...
    public const string ModName = "Fractured Truth";
    public const string ForkId = "Fractured Truth";
    public const string PluginVersion = "0.0.0";
    public const string PluginGuid = "cn.xtremewave.fracturedtruth";
    ...
    private const string DisplayedVersion_Head = "0.0";
    ...
    public const string GithubRepoUrl = "https://github.com/XtremeWave/FracturedTruth/";
    ...
    public override void Load()
    {
        ...
        Msg("========= FracturedTruth loaded! =========", "Plugin Load");
